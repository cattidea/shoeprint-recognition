...
def model(X, is_training, keep_prob):
    ...
    # A1 = tf.contrib.layers.batch_norm(inputs=A1, decay=0.9, updates_collections=None, reuse=tf.AUTO_REUSE, scope="BN1", is_training=is_training)
    A1 = tf.nn.relu(A1)
    ...
    # A2 = tf.contrib.layers.batch_norm(inputs=A2, decay=0.9, updates_collections=None, reuse=tf.AUTO_REUSE, scope="BN2", is_training=is_training)
    A2 = tf.nn.relu(A2)
    ...
    # A3 = tf.contrib.layers.batch_norm(inputs=A3, decay=0.9, updates_collections=None, reuse=tf.AUTO_REUSE, scope="BN3", is_training=is_training)
    A3 = tf.nn.relu(A3)
    ...
    # A5 = tf.contrib.layers.batch_norm(inputs=A5, decay=0.9, updates_collections=None, reuse=tf.AUTO_REUSE, scope="BN4", is_training=is_training)
    # if keep_prob != 1:
    ...
    # A6 = tf.contrib.layers.batch_norm(inputs=A6, decay=0.9, updates_collections=None, reuse=tf.AUTO_REUSE, scope="BN5", is_training=is_training)
    if keep_prob != 1:
    ...
    # A7 = tf.contrib.layers.batch_norm(inputs=A7, decay=0.9, updates_collections=None, reuse=tf.AUTO_REUSE, scope="BN6", is_training=is_training)
    if keep_prob != 1:
