...
from model.layers import inception_v2, maxout, conv2d, separable_conv2d, deepwise_conv2d, nnet_v1
...
class ModelV3(TripletModel):
    ...
    def model(self, X, is_training, keep_prob):
        ...
        # Nnet L1
        X = nnet_v1(input=X, filters=16, scope="Nnet_1", strides=2,
        ...
        # Nnet L2
        X = nnet_v1(input=X, filters=16, scope="Nnet_2a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=32, scope="Nnet_2b", strides=2,
                         activate=True, batch_norm=True, is_training=is_training)
        # mask = tf.layers.max_pooling2d(mask, pool_size=3, strides=2, padding="same")
        # X = tf.cast(tf.greater(mask, 0), tf.float32) * X

        # Nnet L3
        X = nnet_v1(input=X, filters=32, scope="Nnet_3a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=64, scope="Nnet_3b", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)

        # Nnet L4
        X = nnet_v1(input=X, filters=64, scope="Nnet_4a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_4b", strides=2,
                         activate=True, batch_norm=True, is_training=is_training)
        # mask = tf.layers.max_pooling2d(mask, pool_size=3, strides=2, padding="same")
        # X = tf.cast(tf.greater(mask, 0), tf.float32) * X

        # Nnet L5
        X = nnet_v1(input=X, filters=128, scope="Nnet_5a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_5b", strides=2,
                         activate=True, batch_norm=True, is_training=is_training)
        # mask = tf.layers.max_pooling2d(mask, pool_size=3, strides=2, padding="same")
        # X = tf.cast(tf.greater(mask, 0), tf.float32) * X
...
class ModelV5(TripletModel):
    ...
    def model(self, X, is_training, keep_prob):
        ...
        # Nnet L3
        X = nnet_v1(input=X, filters=64, scope="Nnet_3a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=64, scope="Nnet_3b", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=64, scope="Nnet_3c", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_3d", strides=2,
                         activate=True, batch_norm=True, is_training=is_training)

        # Nnet L4
        X = nnet_v1(input=X, filters=128, scope="Nnet_4a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_4b", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_4c", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        # X = nnet_v1(input=X, filters=128, scope="Nnet_4d", strides=2,
        #                  activate=True, batch_norm=True, is_training=is_training)

        # Nnet L5
        X = nnet_v1(input=X, filters=128, scope="Nnet_5a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_5b", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_5c", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_5d", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_5e", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_5f", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)

        # Nnet L6
        X = nnet_v1(input=X, filters=128, scope="Nnet_6a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_6b", strides=2,
                         activate=True, batch_norm=True, is_training=is_training)

        # Nnet L7
        X = nnet_v1(input=X, filters=128, scope="Nnet_7a", strides=1,
                         activate=True, batch_norm=True, is_training=is_training)
        X = nnet_v1(input=X, filters=128, scope="Nnet_7b", strides=2,
                         activate=True, batch_norm=True, is_training=is_training)
